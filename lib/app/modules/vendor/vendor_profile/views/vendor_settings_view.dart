import 'package:flexi_work/app/modules/vendor/vendor_profile/views/vendor_change_password_view.dart';
...
class VendorSettingsView extends GetView {
          ...
          child: Column(
            children: [
              ...
              CustomListTileWithColor(
                ...
                onTap: () {
                  Get.to(() => VendorChangePasswordView());
                },
              ),
              sh16,
              CustomListTileWithColor(
